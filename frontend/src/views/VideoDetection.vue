        ...
        <div class="video-card">
          ...
          <div class="video-controls">
            ...
            <div class="dropdown-wrapper">
              <button class="btn btn-option" @click="showSpeedMenu = !showSpeedMenu">
...
const connectWebSocket = () => {
  websocket = new WebSocket(`ws://${window.location.hostname}:8000/ws/inference`)
  websocket.onopen = () => { 
...
const handleResult = (r) => {
  ...
  stableDetections.value = r.stable_detections || []
  drawDetections(r)
}
